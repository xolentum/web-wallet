...
main(int ac, const char* av[])
{
    ...
    cout << "Mainnet blockchain path: " << blockchain_path << '\n'
         << "Xolentum Version: " << MONERO_VERSION_FULL << '\n';
...

    {
        ...
        cout << "Xolentum donation account: " << *account << '\n';
...

    {
        ...
        cout << "Xolentum forum donation account: " << *primary_account << '\n';
...

    {
        ...
        if (tx->vin.size() == inputs_found.size())
        {
            ...
            cout << "Possible spending from Xolentum project donation is: "
...

    {
        ...
        cout << "Xolentum formum donation account: " << *primary_account << '\n';
        ...
        if (tx->vin.size() == inputs_found.size())
        {
            ...
            cout << "Possible spending from Xolentum fourm donation is: "
                 << print_money(possible_total_spent) << " xmr\n";
        }
    }
